...
func (a *App) Router() http.Handler {
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/voice/livekit-token", a.handleVoiceLiveKitToken)

			r.Post("/dm/conversations", a.handleOpenOrCreateDmConversation)
			...
			r.Get("/friends/requests/outgoing", a.handleFriendRequestsOutgoing)
			r.Post("/friends/requests/{id}/accept", a.handleFriendRequestAccept)
			r.Post("/friends/requests/{id}/reject", a.handleFriendRequestReject)
			r.Get("/friends", a.handleFriendsList)
		})
	})
