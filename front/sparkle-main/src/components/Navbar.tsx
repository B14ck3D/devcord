  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-glass border-b border-border/30">
      <div className="container mx-auto flex items-center justify-between h-16 px-4 lg:px-8">
        ...
        {/* CTA */}
        <button className="hidden lg:block bg-foreground text-background font-bold text-sm px-6 py-2.5 rounded-full hover:bg-foreground/90 transition-colors">
          Otwórz Devcord
        </button>
        ...
        {mobileOpen && (
          ...
          >
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <button className="bg-foreground text-background font-bold text-sm px-6 py-2.5 rounded-full mt-2">
                Otwórz Devcord
              </button>
            </div>
          </motion.div>
