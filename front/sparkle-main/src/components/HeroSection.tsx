      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-foreground text-background font-bold text-base px-8 py-3.5 rounded-full flex items-center justify-center gap-2.5 hover:bg-foreground/90 transition-colors hover:scale-[1.03] active:scale-[0.98] transition-transform">
              <Download size={20} />
              Pobierz dla systemu Windows
            </button>
            <button className="bg-muted/60 text-foreground font-bold text-base px-8 py-3.5 rounded-full flex items-center justify-center gap-2.5 border border-border/40 hover:bg-muted transition-colors hover:scale-[1.03] active:scale-[0.98] transition-transform">
              <Globe size={20} />
